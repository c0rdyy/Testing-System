                ...
                int n=0;//оценка
                    ...
                    switch(prg1){
                        case 1: {
                            ...
                            if (mode_working_theme==2){
                                student[correct_login].rezult_loop = Working_with_themes(1);
                            }
                            break;}
                        case 2: {
                            n=Working_with_themes(2);
                            if (mode_working_theme==2){
                                student[correct_login].rezult_array = Working_with_themes(2);
                            }
                            break;}
                        case 3: {
                            ...
                            if (mode_working_theme==2){
                                ...
                                student[correct_login].rezult_string = Working_with_themes(3);
                            }
                            break;}
                        case 4: {
                            ...
                            if (mode_working_theme==2){
                                ...
                                student[correct_login].rezult_recursion = Working_with_themes(4);
                            }
                            break;}
                        case 5: {
                            n=Working_with_themes(5);
                            if (mode_working_theme==2){
                                student[correct_login].rezult_structure = Working_with_themes(5);
                            }
                            break;}
                        case 6: {
                            n=Working_with_themes(6);
                            if (mode_working_theme==2){
                                student[correct_login].rezult_file = Working_with_themes(6);
                            }
                            break;}
                        case 7: {
                            n=Working_with_themes(7);
                            if (mode_working_theme==2){
                                student[correct_login].rezult_address = Working_with_themes(7);
                            }break;
                        }
                        case 8: {
                            n=Working_with_themes(8);
                            if (mode_working_theme==2){
                                student[correct_login].rezult_dynamic = Working_with_themes(8);
                            } break;
                        }
                            break;
                    }
...
int main (void){
    ...
    for (int i=0; i<count_of_lines; i++){
        ...
        int count_of_symbols=strlen(string_information[i]);
    ...
    for (int i=0; i<count_of_lines; i++){
        fscanf(file_of_student, "%s|%s|%s|%s|%d|%d|%d|%d|%d|%d|%d|%d|%d", students[i].student_name, students[i].student_surname, students[i].login, students[i].password, students[i].rezult_address, students[i].rezult_array, students[i].rezult_dynamic, students[i].rezult_file, students[i].rezult_loop, students[i].rezult_recursion, students[i].rezult_string, students[i].rezult_string, students[i].rezult_final);
    }
    
//      //  проверка читаемости
//        for (int i=0; i<count_of_lines; i++){
//            printf("%d)%s\n %s\n %s\n %s\n %d %d %d %d %d %d %d %d %d\n", i,students[i].student_name, students[i].student_surname, students[i].login, students[i].password, students[i].rezult_loop, students[i].rezult_array, students[i].rezult_string, students[i].rezult_recursion, students[i].rezult_structure, students[i].rezult_file, students[i].rezult_address, students[i].rezult_dynamic, students[i].rezult_final);}
